      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            //for debug
            //cout<<"car_s is "<<car_s<<endl<<"end path s is ="<<end_path_s<<endl;
            //cout<<"car x is "<<car_x<<endl;

            //for(auto i: previous_path_x)
                 //{cout<<"pre_path_x is ="<<i<<endl;}
            //vector<double> pre_ds=getFrenet(previous_path_x[0], previous_path_y[0], deg2rad(car_yaw), map_waypoints_x, map_waypoints_y);
            //cout<<"pre_ds"<<pre_ds[0]<<pre_ds[1]<<endl;
            ...
            cout<<"prev_size is "<<prev_size<<endl;
